  ...
  <div>
      ...
      <form class="mt-8 space-y-6" @submit="register">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          <div>
            <label for="namefull" class="sr-only">Full Name</label>
            <input id="namefull" name="name" type="text" autocomplete="text" required="" 
            v-model="user.name"  class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Full Name" />
          </div>
           <div>
